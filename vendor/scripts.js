...
mr = (function (mr, $, window, document) {
    ...
    mr.dropdowns.documentReady = function ($) {
        ...
        if (!mr.dropdowns.done) {
            ...
            jQuery(document).on('click', '.menu-vertical li a, .pos-vertical-center .btn', function (event) {
                $('.dropdown--active').removeClass('dropdown--active');
                linkClicked = true;
            });
...
function fixedSideBars() {
    var rightColOffset = $(".rightcol").offset().top;
    //var leftColOffset = $(".leftcol").offset().top;
    var maincolumns = $(".maincolumns").height();
    $(window).width();
    //alert(sOffset);
    //alert(sideBarRightHeight);
    $(window).scroll(function () {
        var scrollYpos = $(document).scrollTop();
        if (((rightColOffset + maincolumns - 220) > scrollYpos) && (scrollYpos > rightColOffset)) {
            $(".rightcol .jobs, .leftcol .section").css({
                'top': '120px',
                'position': 'fixed',
